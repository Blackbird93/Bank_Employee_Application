 ...
 * @author victor
 */
public class CloseDepositAccount extends javax.swing.JFrame {

    private ResultSet rs;
    /**
     * Creates new form CloseDepositAccount
     */
    public CloseDepositAccount() {
        initComponents();
    }
    ...
    private void CloseBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CloseBtnActionPerformed
        try{
            ...
            String check = "SELECT * FROM account_type_deposit WHERE iban_id='" + iban + "' and customer_list_id='" + egn + "' ";
            ...
            if (count == 1) {
                String close = "UPDATE account_type_deposit SET is_blocked='1' WHERE iban_id='" + iban + "' and "
                ...
                // update na tablicata deposit sled deaktivirane na smetka
                ...
                String history = "INSERT INTO employee_history (employee_username_id, action_description, "
                        ...
                        + "'has deactivated " + LoadCustomer.getEgn() + " deposit account with iban: " + iban + ". ', SYSDATETIME()) ";
                ...
                try {
                    ...
                    out.println("employee: " + LogIn.getEmployeeID() + " has deactivated " + LoadCustomer.getEgn() + " deposit account with iban:" + iban + ".");
                    out.flush();
                } catch (Exception ex) {
                }
    ...
    private void closeAccCancelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_closeAccCancelActionPerformed
        CloseDepositAccount.this.dispose();
